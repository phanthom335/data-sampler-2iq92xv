        """
        Data Sampler 2iq92xv
        ====================
        Schema-aware processor designed to normalise raw data into clean outputs.
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Schema-aware processor designed to normalise raw data into clean outputs.")
